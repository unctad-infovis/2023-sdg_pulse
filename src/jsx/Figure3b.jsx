  ...
  const createChart = useCallback(() => {
    Highcharts.chart('T4_1_Fig3b', {
      ...
      title: {
        ...
        x: 100,
        text: 'Number of deaths and missing persons'
      },
      tooltip: {
        backgroundColor: '#fff',
        borderColor: '#ccc',
    ...
    chartRef.current.querySelector('#T4_1_Fig3b').style.opacity = 1;
  }, []);
  ...
  return (
    <div className="app">
      <div className="chart_container">
        <div ref={chartRef}>
          {(isVisible) && (<div className="chart" id="T4_1_Fig3b" />)}
        </div>
      </div>

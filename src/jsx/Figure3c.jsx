  ...
  const createChart = useCallback(() => {
    Highcharts.chart('T4_1_Fig3c', {
      ...
      subtitle: {
        ...
        x: 100,
        text: 'As percentage of GDP, 2021'
      },
      title: {
        align: 'left',
        margin: 20,
        ...
        x: 100,
        text: 'Disaster-related economic losses'
      },
      tooltip: {
        backgroundColor: '#fff',
        borderColor: '#ccc',
    ...
    chartRef.current.querySelector('#T4_1_Fig3c').style.opacity = 1;
  }, []);
  ...
  return (
    <div className="app">
      <div className="chart_container">
        <div ref={chartRef}>
          {(isVisible) && (<div className="chart" id="T4_1_Fig3c" />)}
        </div>
      </div>
